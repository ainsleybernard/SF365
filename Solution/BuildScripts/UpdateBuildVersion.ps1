$env:BUILD_SOURCESDIRECTORY = "C:\Users\bernara\Documents\GitHub\SF365_\SF365"
...
## Inspired by https://docs.microsoft.com/en-us/azure/devops/pipelines/scripts/powershell?view=azure-devops&tabs=yaml
##-----------------------------------------------------------------------
